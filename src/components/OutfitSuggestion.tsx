...
function OutfitSuggestion({ user, weather }: OutfitSuggestionProps) {
    if (!user) {
        return (
            <OutfitContainer>
                ...
                <p>Fill out the form first to get a suggestion.</p>
            </OutfitContainer>
        );
    }
    ...
    if (!weather) {
        return (
            <OutfitContainer>
                <h2>Outfit Suggestion</h2>
                <p>We still need the weather. Submit the form if needed.</p>
            </OutfitContainer>
        );
    }
    ...
    return (
        <OutfitContainer>
            ...
            {ageComment && <p>{ageComment}</p>}
            {genderComment && <p>{genderComment}</p>}
        </OutfitContainer>
    );
}
